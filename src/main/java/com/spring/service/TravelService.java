...
public class TravelService {
	...
	public TravelBO getTravelBoObj() {
		return travelBoObj;
	}
	...
	public double calculateTripCharge(String tripId, int distanceTravelled, String hraType)
			throws InvalidDistanceTravelledException {
		...
		// TravelBO travelBO = context.getBean(TravelBO.class);
